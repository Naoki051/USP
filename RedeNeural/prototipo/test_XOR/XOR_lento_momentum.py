import numpy as np
from training import treinamento_mlp_com_momentum_lento, plotar_custos_mlp, prever
...
if __name__ == '__main__':
    ...
    parametros_aprendidos, custos_historico = treinamento_mlp_com_momentum_lento(
